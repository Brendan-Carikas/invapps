...
export declare type TreeRenderFn = ({ node, type, selected, open, Icon, context }: {
    node: TreeNode;
...
declare type CSSNumber = number;
/**
 * @public
 */
export declare type CSSUnit = `${CSSNumber}rem` | `${CSSNumber}em` | `${CSSNumber}px`;
/**
 * @public
 */
